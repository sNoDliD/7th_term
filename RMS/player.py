...
class MediaWindow(QMainWindow):
    ...
    def ui_init(self):
        ...
        self.playback_Label.adjustSize()
    ...
    def open_file(self):
        ...
        for file in filenames:
            if not any(str(file).lower().endswith(x) for x in filetype):
                print(f"Error: unexpected file {file} was ignored")
                continue
